...
import { createLeaderboardSnapshot } from "../repositories/leaderboard-snapshots-repository";
...
export async function calculateMatchPoints(
  ...
  const leaderboardSnapshot = await createLeaderboardSnapshot(supabaseAdmin, {
    sourceType: "match",
    sourceId: matchId,
  });
