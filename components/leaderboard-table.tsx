      ...
      <table className="w-full border-collapse text-black">
        ...
        <tbody>
          {leaderboard?.map((user) => (
            <tr
              key={user.user_id}
              className="border-b border-black/5 transition last:border-b-0 hover:bg-black/5"
            >
              ...
              <td className="px-4 py-4 sm:px-6">
                <div className="flex items-center gap-3">
                  <div className="overflow-hidden rounded-full border border-black/5 bg-white">
                    {user.avatar_url ? (
                      <Image
                        src={user.avatar_url}
